...
public:
    ...
    //send message
    void sendMessage(const std::string& destTopic, const std::string& message);
	void sendMessage(const Destination* destination, const std::string& message, const std::string& correlation_id);
